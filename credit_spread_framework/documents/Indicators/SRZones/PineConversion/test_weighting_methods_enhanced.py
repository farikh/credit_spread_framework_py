...
# Import from the enhanced data loader
from srzone.data_loader_enhanced import prepare_data_for_analysis
...
if __name__ == "__main__":
    ...
    if args.source == 'csv' and data_file and os.path.exists(data_file):
        ...
        print("\nUsage examples:")
        print("  python test_weighting_methods_enhanced.py")
        print("  python test_weighting_methods_enhanced.py --file \"validation/data/SP_SPX, 3m__Linear.csv\"")
        print("  python test_weighting_methods_enhanced.py --source sql --timeframe 1d --end 2025-04-03")
        print("    (This will get up to 4000 bars on or before 2025-04-03)")
        print("  python test_weighting_methods_enhanced.py --source sql --timeframe 1d --start 2025-04-01")
        print("    (This will get ALL bars on or after 2025-04-01 PLUS up to 4000 bars before 2025-04-01)")
        print("  python test_weighting_methods_enhanced.py --source sql --timeframe 1d --start 2025-04-01 --end 2025-04-03")
        print("    (This will get ALL bars between 2025-04-01 and 2025-04-03 PLUS up to 4000 bars before 2025-04-01)")
        print("  python test_weighting_methods_enhanced.py --visualize --output \"output_dir\" --debug")
