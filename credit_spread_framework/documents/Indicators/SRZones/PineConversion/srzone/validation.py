...
from .peak_detection_export import export_peak_detection_data
...
def validate_implementation(data_file=None, tradingview_export=None, tradingview_image=None, params=None, output_dir=None,
    ...
    # Export peak detection data
    peak_csv_path = os.path.join(output_dir, 'python_peaks.csv')
    export_peak_detection_data(
        zone_results.get('peak_indices', []),
        zone_results.get('filtered_scores', []),
        zone_results.get('min_range', 0),
        zone_results.get('bin_size', 0),
        peak_csv_path
    )
